...
<footer>
        <div class="row" style="padding-top: 10px;">
            <div class="col-6">
                <div class="row">
                    <div class="col-5" style="margin-right:-190px;margin-left:140px;">
                        ...
                        <p>
                            <a href="https://www.behance.net/">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="21" viewBox="0 0 24 21">
                                    <text id="behance" transform="translate(0 18)" fill="#8d8d8e" font-size="21" font-family="FontAwesome"><tspan x="0" y="0"></tspan></text>
                                </svg>
                            </a>
            ...
            <div class="col-6">
                <button type="button" class="rounded-pill bouton_contact_footer">CONTACT</button>
            </div>
        </div>
